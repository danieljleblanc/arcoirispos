# backend/src/app/inventory/routes/items_routes.py
...
# ---------------------------------------------------------
# ✔️ Corrected security imports (must live under src.app.auth.services)
# ---------------------------------------------------------
...
from src.app.inventory.services.item_service import item_service

# backend/src/app/pos/routes/terminals_routes.py
...
# ✔️ Correct service import
from src.app.pos.services.terminal_service import terminal_service
...
async def delete_terminal(
    ...
    if not deleted:
        raise HTTPException(
            ...
            detail="Failed to delete terminal",
        )
